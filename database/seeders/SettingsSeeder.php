...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'stats_years',           'value' => '30',                                                     'group' => 'general'],
            ['key' => 'stats_investments',     'value' => '700',                                                    'group' => 'general'],
            ['key' => 'stats_valuation',       'value' => '1',                                                      'group' => 'general'],
            ['key' => 'stats_unicorns',        'value' => '15',                                                     'group' => 'general'],
            ['key' => 'stats_projects',        'value' => '200',                                                    'group' => 'general'],
            ['key' => 'stats_satisfaction',    'value' => '98',                                                     'group' => 'general'],
            ['key' => 'stats_clients',         'value' => '30',                                                     'group' => 'general'],
