...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'stat_funded',              'value' => '4',                                                      'group' => 'general'],
            ['key' => 'stat_lead_investments',   'value' => '35',                                                     'group' => 'general'],
            ['key' => 'stat_investments_count',  'value' => '1562',                                                   'group' => 'general'],
            ['key' => 'stat_diversity_investments','value' => '290',                                                   'group' => 'general'],
            ['key' => 'stat_exits',              'value' => '510',                                                    'group' => 'general'],
            ['key' => 'stat_ai_companies',       'value' => '60',                                                     'group' => 'general'],
            ['key' => 'stat_fintech_crypto',     'value' => '34',                                                     'group' => 'general'],
